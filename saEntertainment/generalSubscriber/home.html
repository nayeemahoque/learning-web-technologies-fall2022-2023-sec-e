        ...
        <table border="0px" width="100%" height="100%">
            ...
            <tr>
                <td rowspan="2" align="center" style="background-color: peachpuff  ;">
                    <img height="150" width="150" src="images/cat.jpg" alt="Profile Picture" style="border-radius:50%; padding-bottom: 24px;">
                    <br>
                    <a href="profile.html">
                        <h3>
                            My Profile
            ...
            <tr>
                <td width = "16%">
                    <img height="20%" width="100%" src="images/books.jpg" alt="book">
                </td>
                <td width = "16%">
                    <img height="20%" width="100%" src="images/movie.jpg" alt="movie">
                </td>
                <td width = "16%">
                    <img height="20%" width="100%" src="images/music.jpg" alt="music">
                </td>
                <td width = "16%">
                    <img height="20%" width="100%" src="images/series.jpg" alt="series">
                </td>
                <td width = "16%">
                    <img height="20%" width="100%" src="images/game.jpg" alt="game">
                </td>
